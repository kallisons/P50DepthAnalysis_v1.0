...
echo "let dens = rho_un(s_an[d=2], t_an[d=3], z[d=5])"

echo "let o2_an3 = (o2_ann_no_time[d=1]/dens)*1000" >> Depth.jnl
...
echo "SAVE/CLOBBER/FILE=\"../../Results/60umolkg_Depth/Hypoxia60_Conc_Depth.nc\" depth_60umolkg" >> Depth.jnl
